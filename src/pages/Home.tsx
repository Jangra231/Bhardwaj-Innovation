...
// Icon mapping helper to securely render icons by key string
...
export default function Home({ onNavigate }: HomeProps) {
  // We'll show a preview of services (all 8 but cleanly summarized)
  const previewServices = SERVICES_DATA;
  // We'll show first 4 products as featured
    ...
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden bg-slate-950">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Abstract floating card element */}
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
      ...
      <section className="relative z-20 -mt-12 max-w-7xl mx-auto px-6">
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, idx) => (
            ...
            >
              <div className="p-3 rounded-full bg-sky-50 text-sky-600 mb-2 transition-colors duration-300 group-hover:bg-sky-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {previewServices.map((service, idx) => (
              ...
              >
                ...
                <div className="pt-6 mt-auto flex items-center text-xs font-semibold text-sky-600 group-hover:text-sky-500 gap-1.5 border-t border-slate-100">
                  Learn More
            ...
            {featuredProducts.map((product, idx) => (
              ...
              >
                ...
                <div className="p-6 pt-0 mt-auto">
                  <button className="w-full py-2.5 bg-slate-50 hover:bg-sky-50 hover:text-sky-600 text-slate-700 border border-slate-100 hover:border-sky-200 transition-colors text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 cursor-pointer">
                    View Details
