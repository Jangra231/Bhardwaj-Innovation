...
export const SERVICES_DATA: ServiceDetail[] = [
  {
    ...
    icon: "MapPin",
    shortDesc:
      "Real-time vehicle tracking with live location tracking, geofencing, ignition status, and instant alerts.",
    longDesc:
      "Our advanced vehicle tracking solution provides real-time, high-precision location monitoring for commercial and private vehicles. Empowered by intelligent 4G hardware and our state-of-the-art software dashboard, you get absolute visibility over your vehicle's movements, routes, and security, anytime and anywhere.",
    image:
    ...
    specifications: {
      ...
      "Tracking Platform":
        "Cloud-based Web Console & Native Mobile Apps (iOS/Android)",
  ...
  },
  {
    ...
    icon: "Truck",
    shortDesc:
      "Complete fleet management solutions with fuel monitoring, driver behavior analysis, and automated maintenance scheduling.",
    longDesc:
      "Transform raw fleet metrics into operational power. Our Fleet Management system tracks vehicle diagnostics, analyzes driver performance, optimizes fuel usage, and streamlines complex compliance schedules, resulting in reduced overheads and heightened safety across your transport organization.",
    image:
    ...
    specifications: {
      ...
      "Diagnostics Captured":
        "Engine RPM, Coolant Temp, Error Codes (DTCs), Fuel Flow Rate",
      "Multi-Vehicle View":
        "Up to 10,000+ active fleet units on a single map interface",
...

  {
    ...
    icon: "Camera",
    shortDesc:
      "Full HD smart fleet dashcams with ADAS, Driver Monitoring (DMS), and real-time live video streaming.",
    longDesc:
      "Upgrade your fleet safety with smart dashcams powered by Artificial Intelligence. Designed with Advanced Driver Assistance Systems (ADAS) and Driver Monitoring Systems (DMS), our solutions track road hazards and detect driver distraction or fatigue in real-time, streaming high-definition video evidence directly to the cloud.",
    image:
    ...
    specifications: {
      ...
      "Night Vision":
        "Infrared LED array for crystal clear cabin visibility in 100% darkness",
    },
    applications: [
  ...
  },
  {
    ...
    icon: "UserCheck",
    shortDesc:
      "Discreet and portable tracking solutions for children, elderly safety, field employees, and personal assets.",
    longDesc:
      "Protect what matters most. Our personalized GPS trackers are compact, lightweight, and equipped with SOS panic buttons and two-way voice communication, allowing you to stay connected with vulnerable family members or monitor field staff operations smoothly.",
    image:
  ...
  },
  {
    ...
    icon: "Cpu",
    shortDesc:
      "Tailor-made software, responsive dashboards, enterprise ERP integrations, and mobile tracking applications.",
    longDesc:
      "Achieve absolute control with custom software tailored to your specific telemetry workflows. We design and build secure, hyper-scalable cloud dashboards, analytical engines, and native mobile apps that integrate seamlessly with your existing enterprise architecture, warehouse managers, and custom sensors.",
    image:
      "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=1000",
    gifUrl: "/media/software solutions.jpeg",
    videoUrl: "/media/solution-v.gif",
    gallery: [
      "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=1000",
  ...
  },
  {
    ...
    icon: "Building",
    shortDesc:
      "Compliant tracking solutions matching strict government regulations, public transport buses, and utility vehicles.",
    longDesc:
      "We provide specialized, compliant solutions for municipal, regional, and national government fleets. Designed in strict accordance with AIS-140 and national standard mandates, our hardware and tracking servers support public safety systems, city buses, waste disposal vectors, and emergency vehicles.",
    image:
    ...
    specifications: {
      ...
      "SIM Backup":
        "Dual eSIM/Nano-SIM with automated network roaming failover",
      "Emergency Support":
        "Physical SOS panic buttons, immediate backend SOS broadcast routing",
  ...
  },
  {
    ...
    icon: "Zap",
    shortDesc:
      "Smart battery management systems (BMS) with cell monitoring, balancing, and state-of-health diagnostics for EVs.",
    longDesc:
      "Maximize the safety, efficiency, and longevity of Electric Vehicle batteries. Our Smart Battery Management Systems (BMS) offer microsecond-level scanning of cell voltages, dynamic passive and active cell balancing, temperature thermal runway triggers, and real-time battery analytics telemetry.",
    image:
    ...
    specifications: {
      ...
      "Cell Series Supported":
        "4S to 24S standard (expandable via cascading controllers)",
...

  {
    ...
    icon: "Shield",
    shortDesc:
      "Premium AIS-compliant microprismatic retroreflective tapes for high vehicle and industrial safety.",
    longDesc:
      "We provide industry-leading, government-approved microprismatic retroreflective tapes. Engineered for extreme visibility in dark, rainy, or dusty conditions, our reflective tapes ensure absolute safety compliance for commercial trucks, trailers, and public transit assets, vastly reducing nighttime collisions.",
    image:
    ...
    specifications: {
      ...
      "Standard Color Patterns":
        "Solid Yellow, Solid Red, Alternating Red/White, Chevron",
...

  {
    ...
    shortDesc:
      "Reliable technical assistance to ensure smooth operation, troubleshooting, and continued performance of deployed technology solutions.",

    longDesc:
      "Our Technical Support services are designed to help businesses maintain reliable and uninterrupted operations after the deployment of technology solutions. We provide practical assistance for troubleshooting, system configuration, connectivity issues, device-related concerns, software and platform issues, and operational challenges. Our support approach focuses on identifying issues efficiently, minimizing downtime, and helping customers maintain smooth day-to-day operations.",
    ...
    features: [
      ...
      "Device and connectivity assistance",
      "Software and platform support",
      "Remote technical assistance",
      "Device and system diagnostics",
      "Performance and functionality checks",
      "Guidance for day-to-day system operations",
    ],

    specifications: {
      "Support Type": "Technical & Operational Support",
      "Support Mode": "Remote and On-Site Assistance",
      Coverage: "Hardware, Software and Connectivity",
      Troubleshooting: "System and Device Diagnostics",
      Application: "GPS, CCTV, Fleet and Business Technology",
    },
...

  {
    ...
    shortDesc:
      "Professional installation, configuration, testing, and deployment of technology solutions for vehicles, businesses, industrial environments, and operational facilities.",

    longDesc:
      "Our Installation & Deployment services ensure that technology solutions are professionally installed, configured, tested, and made ready for operational use. We support the deployment of GPS trackers, vehicle monitoring devices, dash cameras, CCTV systems, security solutions, connected devices, and other technology products. Our installation process focuses on proper setup, reliable connectivity, system configuration, functionality testing, and operational readiness.",
    ...
    features: [
      ...
      "GPS tracker installation and configuration",
      "Vehicle-mounted system installation",
    ...
    specifications: {
      "Service Type": "Professional Installation & Deployment",
      Installation: "Vehicle and Fixed-Location Installation",
      Configuration: "Device and System Configuration",
      Testing: "Functionality and Connectivity Testing",
      Application: "GPS, CCTV, Dash Cams and IoT Solutions",
    },
...

  {
    ...
    shortDesc:
      "Continued support, maintenance, and assistance to help customers maintain reliable performance and long-term value from their technology solutions.",

    longDesc:
      "Our After-Sales Service provides continued assistance to customers beyond the initial purchase and installation of technology solutions. We focus on maintaining reliable system performance through ongoing technical assistance, troubleshooting, maintenance coordination, system checks, and operational support. Our objective is to build long-term customer relationships by providing responsive assistance and helping customers get maximum value from their deployed technology solutions.",
    ...
    features: [
      ...
      "Product and system troubleshooting",
      "Maintenance coordination",
      "System performance checks",
      "Device functionality support",
      "Configuration and operational assistance",
      "Customer service assistance",
      "Support for long-term system reliability",
    ],

    specifications: {
      "Service Type": "After-Sales Support & Maintenance",
      Support: "Technical and Operational Assistance",
      Maintenance: "System Checks and Maintenance Coordination",
      Coverage: "Hardware, Software and Connected Solutions",
      Application: "GPS, CCTV, Fleet and Business Technology",
    },
